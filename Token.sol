...
contract MoonStoneGamesToken is Context, IERC20, Ownable {
    ...
    string private _name = "MoonStoneGames";
    string private _symbol = "MSG";
    uint8 private _decimals = 18;

    // For liquidity 2%, for marketing 2%
    ...
    constructor () {
        ...
        //prod
        uniswapV2Pair = IUniswapV2Factory(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73) 
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        require(_maxTxAmount < maxTxPercent, "You can't provide less transaction amount.");
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // take liqidity bsc, save marketing BNB
        uint256 newBalance = address(this).balance.sub(initialBalance).mul(50).div(10**2);
    ...
    function withdrawMarketingBsc() public onlyOwner{
        require(payable(msg.sender).send(address(this).balance));
    }

    function checkMarketingBsc() public onlyOwner view returns (uint256){
        return address(this).balance.mul(10**18);
    }

    function checkLiqCounter() public view returns (uint256){
        return liqAdd;
    }
}
